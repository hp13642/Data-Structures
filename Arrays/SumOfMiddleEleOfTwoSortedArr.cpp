...
Solution Approach-
Metod-1 Count while merging if count reach to 'n' for '2n' element then take the avg of 'n' and 'n+1' th element
Time complexity=O(n)
Method-2
Use Devide Method and comparing medians of two array
Algorithm-
